...
public class IdleController {
	 ...
	 * @param npc Character for which to handle idle movement
	 */
	public static void moveIdle(GCharacter npc) {
		switch (npc.getPatrolPattern()) {
			...
			case PATROL_CW:
				// Patrol the NPC CW
				patrolStatic(npc, true);
				break;
			case PATROL_CCW:
				// Patrol the NPC CCW
				patrolStatic(npc, false);
				break;
			case SURFACE_CW:
				// Surface follow CW
				surfaceFollow(npc, true);
				break;
			case SURFACE_CCW:
				// Surface follow CCW
				surfaceFollow(npc, false);
				break;
			default: 
				// Do nothing
				return;
	 ...
	 * @param npc Character for which to handle wandering movement
	 */
	 ...
	 * @param npc Character for which to handle patrolling movement
	 */
	 ...
	 * @param npc Character for which to handle patrolling movement
	 * @param isCW True = Clockwise rotation | False = Counter-clockwise rotation
	 */
	private static void patrolStatic(GCharacter npc, boolean isCW) {
		...
		Dimension rotateDirection = getRotation(xPat, yPat, isCW);
	...
	/**
	 * Calculates the appropriate rotation directions
	 * @param xPat Current X patrol direction
	 * @param yPat Current Y patrol direction
	 * @param isCW True = Clockwise rotation | False = Counter-clockwise rotation
	 * @return Dimension indicating new (X, Y) patrol direction
	 */
