...
public class Armory {
	...
	// Bare fists
	public static final Fists bareFists = new Fists("Bare Fists", 1, 1, 0.00, 1.0, 2.0, 0, 10,
			"WEAPON (Fist): Slap'em!",
			GPath.createImagePath(GPath.PICKUP, GPath.WEAPON, "bareFists.png"));
	
	// Padded Fists (Caestus)
	public static final Fists caestus = new Fists("Caestus", 1, 2, 0.00, 1.0, 2.5, 0, 6,
	...
	// Brick Pads
	public static final Fists brickPads = new Fists("Brick Pads", 2, 3, 0.00, 1.0, 2.5, 0, 6,
	...
	// Lowly Broken Sword
	public static final Sword brokenSword = new Sword("Broken Sword", 1, 2, 0.1, 2.0, 1.0, 0, 5,
	...
	// Iron Sword
	public static final Sword ironSword = new Sword("Iron Sword", 1, 3, 0.1, 2.0, 1.0, 0, 5,
	...
	// Rusted Sabre
	public static final Sword rustedSabre = new Sword("Rusted Sabre", 1, 4, 0.1, 1.8, 1.0, 0, 5,
	...
	// Steel Sword
	public static final Sword steelSword = new Sword("Steel Sword", 1, 5, 0.1, 1.8, 1.0, 0, 5,
			"WEAPON (Sword): A well-sharpened sturdy sword.",
			GPath.createImagePath(GPath.PICKUP, GPath.WEAPON, "ironSword.png"));
	
	// Special 'D20' Sword
	public static final Sword luckSword = new Sword("D20 Sword", 1, 20, 0.01, 5.0, 1.0, 1, 5,
	...
	// Glass Shard Dagger
	public static final Dagger glassShard = new Dagger("Glass Shard", 1, 2, 0.2, 2.5, 1.0, 0, 10,
	...
	// Spine Dagger
	public static final Dagger spineShiv = new Dagger("Spine Shiv", 1, 3, 0.2, 2.0, 1.0, 0, 10,
	...
	// Box Cutter
	public static final Dagger boxCutter = new Dagger("Box Cutter", 2, 3, 0.2, 2.5, 1.0, 0, 10,
	...
	// Lowly Toy Crossbow
	public static final Crossbow toyCrossbow = new Crossbow("Toy Crossbow", 1, 1, 0.1, 2.0, 2.0, 0, 7,
	...
	// Lowly Twig Bow
	public static final Bow twigBow = new Bow("Twig Bow", 1, 1, 0.05, 2.0, 3.0, 0, 5,
	...
	// Wooden Targe
	public static final Shield woodenTarge = new Shield("Wooden Targe", 1, 2, 3, 0.15, 1.5, 1.0, 0, 2,
	...
	// Buckler
	public static final Shield buckler = new Shield("Buckler", 1, 3, 4, 0.15, 1.5, 1.0, 0, 2,
	...
	// Bone Club
	public static final Hammer boneClub = new Hammer("Bone Club", 2, 3, 0.05, 1.75, 1.0, 0, 4,
